...
4. Contexto do projeto: `project-config.yaml`. Onde ler código do produto, contexto, outputs, histórico e protótipo: constituição §3. Se existir, o `AGENTS.md`/`CLAUDE.md` local.
