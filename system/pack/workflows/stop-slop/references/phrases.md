...
Fonte: [stop-slop](https://github.com/hardikpandya/stop-slop) (MIT). Seção PT-BR no final:
padrões equivalentes na prosa em português.
...
- "Neste artigo/texto vamos"
- "Sem mais delongas"
- "Em um mundo cada vez mais"
- "No contexto atual"
- "Não se trata de X, mas de Y"
- "Em suma" / "Em conclusão" / "Por fim, é possível afirmar"

Muletas:

- "claramente", "obviamente", "basicamente", "simplesmente", "realmente"
- "de forma eficaz", "de maneira significativa"
- "o cenário atual", "navegar os desafios", "mergulho profundo"
